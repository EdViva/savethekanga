    ...
    <td valign="top" bgcolor="#FFFFFF" class="maincell"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td class="headingtxt">For Claudia<br>
                  Let me know what image numbers you want to use for what pages</td>
              </tr>
              <tr>
              <?
...
print "<div class=\"float\">$pid<br><A href=\"image.php?pid=$pid&catid=$catid\"><IMG src=\"$catid/thumbnails/$imagename\" border=\"2\" alt=\"$imagename\"></A></div> ";
}
	?>
	                </td>
              </tr>
