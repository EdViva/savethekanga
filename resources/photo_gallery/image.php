...
<?
	...
	$query="SELECT * FROM $table2name WHERE pid='$pid'";
...
print "<center>\n";	
print "<IMG src=\"$catid/images/$imagename\" border=\"2\" alt=\"$imagename\"></A>\n";
print "</center>";
	if ($description){
	print "<strong><p><center>$description</center></p></strong>";
	}
	}
	?>
              </td>
