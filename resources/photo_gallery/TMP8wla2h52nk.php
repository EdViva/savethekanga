    ...
    <td valign="top" bgcolor="#FFFFFF" class="maincell"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td class="subheadingtxt">Sub Heading</td>
              </tr>
              <tr> 
                <td valign="top"> 
                  <?
...
$link=mysql_pconnect ($host,$user,$password);
	...
	print "$cat<br>";
		...
		$query="SELECT * FROM $tablename WHERE parent='$catid'";
...
?>
          ...
          <td width="130" valign="top" class="smalltext"> <p><strong>&gt; Relevent<br>
              &gt; <a href="#" class="plain">Links</a><br>
              &gt; <a href="#" class="plain">Go Here</a></strong></p>
            <p><strong>Picture / Text for Pics / Other stuff goes here</strong></p></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
